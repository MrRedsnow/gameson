...
export async function ensureSchema() {
  ...
  initialization = (async () => {
    const statements = [
      ...
      `CREATE TABLE IF NOT EXISTS werewolf_votes (lobby_id TEXT NOT NULL, match_number INTEGER NOT NULL, cycle INTEGER NOT NULL, phase TEXT NOT NULL, voter_id TEXT NOT NULL, target_id TEXT NOT NULL, created_at INTEGER NOT NULL, PRIMARY KEY (lobby_id, match_number, cycle, phase, voter_id))`,
